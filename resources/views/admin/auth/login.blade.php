            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.login') }}" role="form">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                                class="btn btn-lg btn-lg w-100 mt-4 mb-0" style="background: #001021">Login
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div
                        ...
                        <div
                            class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background: #001021">
